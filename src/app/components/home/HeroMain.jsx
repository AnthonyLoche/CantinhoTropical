...
const SLIDES = [
  { id: 1, image: cao, label: "Cães" },
  { id: 2, image: reptil, label: "Répteis" },
  { id: 3, image: aves, label: "Aves" },
  { id: 4, image: hamster, label: "Roedores" },
  { id: 5, image: peixes, label: "Aquariofilia" },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.left}>
          ...
          <div className={styles.buttons}>
            <button onClick={handleCatalog} className={styles.btnPrimary}>
              <ShoppingBag size={18} />
              Explorar Catálogo
            </button>
